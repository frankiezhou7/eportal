...
const defs = [
  {
    ...
    children: [{
      ...
      props: {
        ...
        unitLabelText: 't',
        floatingLabelText:'Light Ship Displacement',
        defaultValue:'#lightShip',
        checkOnBlur: 'true',
        validType: 'number',
      },
    },{
      ...
      props: {
        ...
        unitLabelText: 't',
        floatingLabelText:'Loaded Displacement',
...
const ShipDisplacement = React.createClass({
...
module.exports = ShipDisplacement;
