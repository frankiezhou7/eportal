...
const ServiceContent = React.createClass({

  mixins: [AutoStyle, Translatable],

  translations: require(`epui-intl/dist/ServiceContent/${__LOCALE__}`),
  contextTypes: {
    ...
    return (
      <div style={this.style('root')}>
        ...
        <p style={this.style('p')}>
          {this.t('nTextServiceContentSecondary')}
        </p>
        <div style={this.style('content')}>
          <h4 style={this.style('h4')}>Terms & Conditions</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Privacy Statement</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Disclaimer</h4>
          <h4 style={this.style('h4')}>Exclusions and Limitations</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Register and Security</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Rules of Conduct</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Managing Content</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Confidential Information</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Cookies</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Links</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Age and Responsibility</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Intellectual Property</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Notification of Changes</h4>
          <p style={this.style('p')}>
          ...
          <h4 style={this.style('h4')}>Communications</h4>
          <p style={this.style('p')}>
