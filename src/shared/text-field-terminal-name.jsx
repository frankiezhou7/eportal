...
const TextFieldTerminalName = React.createClass({
  mixins: [AutoStyle, Translatable],

  translations: [
    require(`epui-intl/dist/Terminal/${__LOCALE__}`),
  ],
  ...
  render() {
    ...
    return (
      <TextField
        ...
        floatingLabelText={floatingLabelText || this.t('nTextTerminalName')}
        fullWidth={fullWidth}
        hintStyle={hintStyle}
        hintText={hintText}
        id={id}
...
module.exports = TextFieldTerminalName;
