...
const TextFieldPosition = React.createClass({
  mixins: [Translatable],
  ...
  render() {
    ...
    return (
      <TextField
        ...
        floatingLabelText={this.t('nLabelPosition') || 'Title'}
        fullWidth={fullWidth}
        hintStyle={hintStyle}
        hintText={hintText}
        id={id}
...
TextFieldPosition.displayname = 'TextFieldPosition';

module.exports = TextFieldPosition;
